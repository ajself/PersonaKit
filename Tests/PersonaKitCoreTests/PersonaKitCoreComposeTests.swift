...
@Suite("PersonaKitCore Compose")
struct PersonaKitCoreComposeTests {
  ...
  func deterministicComposeForExamplePackPersonas() throws {
    let packURL = coreTestsRepoRootURL().appendingPathComponent("Examples/personakit.pack.json")
    ...
    seniorSections["context"] = "Repo: PersonaKit"
  ...
  func resolvedJSONDeterministicEncoding() throws {
    ...
    let personaURL = coreTestsRepoRootURL().appendingPathComponent(
      "Examples/personakit.persona.json")
  ...
  func cliOutputMatchesCorePrompt() throws {
    ...
    sections["context"] = "Repo: PersonaKit"

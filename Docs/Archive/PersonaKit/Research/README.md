...
Track historical research artifacts used to define pre-Orbit repo initiatives,
including Taskboard v2 decisions.

This folder no longer reflects the active Orbit product direction.

For Orbit direction-setting, use `Docs/Orbit/` planning, architecture, and RFC
documents first.
...
1. Include source URL for every factual claim.

...
| Participation roles and completion state clarity | `studio-interaction-quality-lead` and `studio-coverage-architect` | state walkthrough and Packet 4 review | roles, active/completed/partial/failed state, and failure behavior are visible and coherent | state stays hand-wavy or aggregate success hides per-participant or full-exchange failure |

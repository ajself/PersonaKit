...
1. `Docs/Plan/logs/gardening-health-snapshots.schema.json`
2. `Docs/Plan/logs/gardening-health-snapshots.jsonl`
3. `Docs/Plan/logs/gardening-recommendation-feedback.schema.json`
4. `Docs/Plan/logs/gardening-recommendation-feedback.jsonl`

...
| PSG-003 | Medium | Add a recurring closeout checklist entry for pack/session maintenance | Keeps maintenance from being skipped at phase transitions | `Docs/Plan/TODO.md`, `pack-gardener-log.md` | Done (2026-03-07) |

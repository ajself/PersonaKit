...
.PHONY: help doctor build build-app build-cli install_cli install_zsh_completion run test test-cli cli init validate validate-repo closeout-local orbit-live-db-proof orbit-live-db-proof-local orbit-transport-proof orbit-m3-proof-local export list graph zip format-check
